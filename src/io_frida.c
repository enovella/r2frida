...
static char *__system(RIO *io, RIODesc *fd, const char *command) {
	...
	if (!strcmp (command, "help") || !strcmp (command, "h") || !strcmp (command, "?")) {
		...
		".\\i*                       Import Frida to r2 target information\n"
		".\\iE* (<lib>)              Import Frida to r2 target exports\n"
		".\\ii* (<lib>)              Import Frida to r2 target imports\n"
		".\\is* (<lib>)              Import Frida to r2 target symbols\n"
		...
		"dth (<addr>|<sym>) (x y z) Define function header (z=string,d=int,...)\n"
